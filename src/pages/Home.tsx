...
const carouselSlides = [
  {
    ...
    highlight: "fermes agro-pastorales rentables en Afrique",
    description:
      "Nous vous accompagnons à chaque étape de votre projet, de l'idée à la gestion en passant par l'implantation même de votre ferme.",
  },
  {
